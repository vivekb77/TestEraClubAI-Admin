...
function GetTestEraData(){


   const database = firebase.database();
   
   
database.ref('/TestEraAssistant').orderByChild("createdDate").limitToLast(100) 
...
function AddTestEraData (VAArray){
...
database.ref('/TestEraAssistant').orderByChild("TestorStoriesType")
   .once("value",function(ALLRecords){
       ALLRecords.forEach(
           function(CurrentRecord) {
              
   var TestorStoriesType   = CurrentRecord.val().TestorStoriesType;
   ...
   document.getElementById('testcasesqueried').innerText="Total Test Cases --- "+countTestCases; 
   document.getElementById('userstoriesqueried').innerText="Total User Stories --- "+countUserStories; 
 });
